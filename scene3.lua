...
function scene:createScene( event )
	...
	local image = display.newImage( "bg3.jpg" )
	screenGroup:insert( image )
	
	image.touch = onSceneTouch
	
	local text1 = display.newText( "Scene 3", 0, 0, native.systemFontBold, 24 )
...
function scene:enterScene( event )
	...
	-- remove testscreen2's view
	storyboard.purgeScene( "testscreen2" )
end
